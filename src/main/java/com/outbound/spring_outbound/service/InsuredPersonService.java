...
public interface InsuredPersonService {
    ...
    void createInsuredPerson(InsuredPerson insuredPerson,ChildInformation childInformation, int journeyToId, int destinationCountryId,BeneficiaryInfomation beneficiaryInfomation,boolean isChild);
